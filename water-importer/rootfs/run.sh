...
export INFLUX_HOST=$(bashio::config 'influx_host' 'localhost')
export INFLUX_PORT=$(bashio::config 'influx_port' '8086')
export INFLUX_DB=$(bashio::config 'influx_db' 'homeassistant')
export INFLUX_USER=$(bashio::config 'influx_user' 'admin')
export INFLUX_PASSWORD=$(bashio::config 'influx_password' 'admin123')
